...
HD_PWD='C:/Users/Utente/Desktop/FUNZIONE SENO IN VIRGOLA FISSA/FUNZIONE SENO IN VIRGOLA FISSA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_calculator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sine_calculator.tcl -notrace
