...
HD_PWD='C:/Users/Utente/Desktop/FUNZIONE SENO IN VIRGOLA FISSA/FUNZIONE SENO IN VIRGOLA FISSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_calculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sine_calculator.tcl
